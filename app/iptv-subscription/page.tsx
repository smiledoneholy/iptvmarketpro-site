...
export default function Page() {
  return <main id="main-content"><SiteHeader/><header className="article-hero subscription-hero">
  ...
  </header><article className="article-body subscription-body" data-no-translate>
  ...
  </article><section className="detail-cta"><h2>Ready to check your setup?</h2><p>Have your device model and viewing requirements ready. We can help you check them before payment.</p><a className="button" href="/contact">Ask about compatibility</a><p><a href="/plans">View all subscription plans â†’</a></p></section><SiteFooter/></main>;
}
